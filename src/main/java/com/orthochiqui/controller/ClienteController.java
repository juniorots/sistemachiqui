...
public class ClienteController {
	...
	public ResponseEntity<Cliente> createCliente(@RequestBody Cliente cliente) {
		try {
			Cliente c =	clienteService.getClienteByProntuario(cliente.getProntuario());
			if (c != null) 
	...
	@DeleteMapping("/clientes/prontuario/{prontuario}")
	public ResponseEntity<HttpStatus> deleteCliente(@PathVariable("prontuario") String prontuario) {
		try {
			clienteService.deleteCliente(prontuario);
